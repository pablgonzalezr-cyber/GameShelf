...
public class HistorialReservaResponseDTO {
    ...
    @Schema(description = "Estado anterior de la reserva antes del cambio.", example = "PENDIENTE")
    private String estadoAnterior;

    @Schema(description = "Nuevo estado asignado a la reserva.", example = "CONFIRMADA")
